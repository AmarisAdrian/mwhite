	...
	if ($flag == 0) {
		...
		if  ($user->save() && $user_prof->save()) {
			if ($request->postVar('val-client')) {
				redirectTo($base_url . "admin/edit-profile.php?step=economic-labour");
			}
			if ($request->postVar('val-client-labour')) {
				redirectTo($base_url . "admin/edit-profile.php?step=references");
			}
			if ($request->postVar('val-client-references')) {
				redirectTo($base_url . "admin/edit-profile.php?step=documents");
			}
			if ($request->postVar('val-client-documents')) {
				redirectTo($base_url . "admin/edit-profile.php?step=request");
			}
			...
			<div class="page-content col-lg-9 col-md-12 col-sm-12 col-lg-push-3">
				...
				<div class="page-header">
					...
					<nav class="nav nav-pills">
						<a class="nav-item nav-link <?php if ($step == "basic-information") {
														echo "active";
													} ?>" href="<?php echo $base_url . "admin/edit-profile.php?step=basic-information"; ?>" id="pills-basic-information" role="tab" aria-controls="pills-basic-information"><i class="fa fa-address-card" aria-hidden="true"></i> Informacíon básica</a>
						<a class="nav-item nav-link <?php if ($step == "economic-labour") {
														echo "active";
													} ?>" href="<?php echo $base_url . "admin/edit-profile.php?step=economic-labour"; ?>" id="pills-economic-labour" role="tab" aria-controls="pills-economic-labour"><i class="fa fa-briefcase" aria-hidden="true"></i> Laboral y Económica</a>
						<a class="nav-item nav-link <?php if ($step == "references") {
														echo "active";
													} ?>" href="<?php echo $base_url . "admin/edit-profile.php?step=references"; ?>" id="pills-references" role="tab" aria-controls="pills-references"><i class="fa fa-users" aria-hidden="true"></i> Referencias</a>
						<a class="nav-item nav-link <?php if ($step == "documents") {
														echo "active";
													} ?>" href="<?php echo $base_url . "admin/edit-profile.php?step=documents"; ?>" id="pills-documents" role="tab" aria-controls="pills-documents"><i class="fa fa-file-o" aria-hidden="true"></i> Documentos</a>
					</nav>
				</div>
				...
				?>
					<div class="add-client">
						<form id="Frmcliente" enctype="multipart/form-data" method="POST" action="<?php echo $base_url . "admin/edit-profile.php"; ?>">
							<div class="row">
