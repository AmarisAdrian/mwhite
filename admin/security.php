...
if ($request->isPost() && $request->postVar('val-security')) {
	...
	if($flag == 0){
		...
		if  ($user->save()) {
			Core::alert('Correcto','Datos actualizados',$base_url . "admin/index.php");	
		}
	} 
	else if($flag == 1){
		Core::alert('Error','Las contraseñas no coinciden',$base_url . "admin/security.php ");
	}
	else{
		$error = $connect->error;
		Core::alert('Error','Se ha presentado un problema',$base_url . "admin/index.php");	
	}
}
?>
	...
	<div class="container-fluid">
		<div class="row row-eq-height">
			...
			<div class="page-content col-lg-9 col-md-12 col-sm-12 col-lg-push-3">
				...
				<?php	?>
					<div class="add-security-admin">
                       		<form id="FrmSecurity" enctype="multipart/form-data" method="POST"
						action="<?php echo $base_url . "admin/security.php"; ?>">
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input class="form-control" type="password" id="password_repeat" name="password_repeat" placeholder="repetir password" required>
									...
									<div class="col-md-4">
										<div class="form-group">
											<div class="field-label"><label for="email">Cambiar Correo electronico</label></div>
