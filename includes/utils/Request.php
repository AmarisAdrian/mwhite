...
require_once LIB_ROOT . '/lib/php-user-agent/phpUserAgent.php';
require_once LIB_ROOT . '/lib/php-user-agent/phpUserAgentStringParser.php';
...
class Request
{
    ...
    public function __construct()
    {
        ...
        $this->rootUrl = '/' . trim(preg_replace('/\index(_\w+)?\.php.*/', '', $this->uri), '/');
    ...
    {
        return isset($this->getVars[$name]) ? ($safe ? $this->escape($this->getVars[$name]) : $this->getVars[$name]) : null;
    }
    ...
    {
        return isset($this->postVars[$name]) ? ($safe ? $this->escape($this->postVars[$name]) : $this->postVars[$name]) : null;
    }
