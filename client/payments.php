        ...
        <div class="modal-body payment-modal">
          ...
          <?php if (isset($_POST['edit_id'])) {
            ...
            <div class="payment-modal">
              <h3><?php echo $lang['Select a Payment method']; ?></h3>
            </div>
          ...
          <div class="row" style="margin-top: 20px;">
            <div class="col-sm-8 encryptedinfo">
              <h5><b><?php echo $lang['Your current information is encrypted']; ?></b> </h5>
              <p><?php echo $lang['Fully Secured Accounts your credit card detalis will not be saved on this server']; ?></p>
            </div>
            <div class="col-sm-4 encryptedlogo">
              <h5><b><?php echo $lang['System secure by']; ?></b> </h5>
              <img src="<?php echo $url; ?>/images/comodo-ssl.png" />
            </div>
            <hr>
            <div class="col-sm-12" style="margin-top: 20px;">
              <h5><b><?php echo $lang['We accecpt']; ?></b></h5>
              <img src="<?php echo $url; ?>/images/gatways.png" />
            </div>
          </div>
        </div>
      </div>
