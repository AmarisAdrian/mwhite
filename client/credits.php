...
$title = "Mis creditos | " . $syatem_title;
						...
						<div class="row project-dash">
							<div class="col-sm-6">
								<div class="pm-heading">
									<h2>Gestionar creditos</h2>
									<span>Solicitudes y creditos activos</span>
								</div>
							</div>
							<div class="col-sm-6 creative-right text-right">
								<div class="pm-form" style="width: 100%;">
									<form class="form-inline md-form form-sm">
										<input class="form-control form-control" type="text" placeholder="Buscar solicitud" id="protbl-input">
								...
								<table class="table table-new projectspage clientside" data-pagination="true" data-page-size="5">
									...
									<tbody id="projects-tbl">
										...
										if ($recentProjects == NULL) {
											echo '<tr><td colspan="8">No tiene creditos activos </td></tr>';
										}
